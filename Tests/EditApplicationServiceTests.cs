...
public class EditApplicationServiceTests
{
    private readonly EditApplicationService _service = new();
    ...
    public void HorizonRotationWithoutCrop_LeavesNoBlankBorders(uint width, uint height, double degrees)
    {
        ...
        _service.ApplyEdits(image, new EditSettings { HorizonRotation = degrees });
    ...
    public void HorizonRotationWithUserCrop_LeavesNoBlankPixels()
    {
        ...
        _service.ApplyEdits(image, settings);
