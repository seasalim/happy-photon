param([ValidateSet('G1','G2','G5','G9','G9Stage','QualifiedG5','QualifiedRadialG9Eight','QualifiedRangeControlTick','QualifiedRangeControlContention','QualifiedRangeControlExport','QualifiedRangeClassification','QualifiedRangeClassificationExport','QualifiedRangeOverlay','QualifiedRangeReliability')][string]$Gate = 'G1',
