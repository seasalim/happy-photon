...
| Sdcb.LibRaw.runtime.win64 and runtime.linux64 | 0.21.1 | LGPL-2.1-only OR CDDL-1.0 |
...
The Windows and Linux runtime packages contain LibRaw 0.21.1 native binaries
and declare `LGPL-2.1-only OR CDDL-1.0`. Happy Photon selects
...
Windows/Linux files, versions, package hashes, and binary hashes are recorded
in
