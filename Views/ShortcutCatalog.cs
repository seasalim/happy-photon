...
public static class ShortcutCatalog
{
    ...
    private static ShortcutReachabilityClaim Loupe(string action, string controlName) =>
        ShortcutReachabilityClaim.Control(action, controlName, ShortcutWorkspace.Loupe);
    ...
    [
        ...
        [
            new("G", "Return to the Browse grid",
            [
                Browse("Switch to Browse", "BrowseTabButton"),
                Loupe("Return to the Browse grid", "LoupeGridButton")
            ]),
            new("D", "Switch to Develop",
            [
                Browse("Switch to Develop", "DevelopTabButton"),
                Loupe("Switch to Develop", "DevelopTabButton")
            ]),
            new("E", "Toggle the Browse Loupe for the active image",
            [
                Browse("Open Browse Loupe", "LoupeViewButton"),
                Loupe("Return to the Browse grid", "LoupeViewButton")
            ]),
            new("Enter", "Open Loupe, enter Develop from Loupe, run Export, or apply crop",
            [
                Browse("Open Browse Loupe", "LoupeViewButton"),
                Loupe("Switch to Develop", "DevelopTabButton"),
            ...
            [
                ...
                Loupe("Enter fullscreen", "LoupeFullScreenButton"),
            ...
            [
                ...
                Loupe("Previous image", "LoupePreviousButton"),
                Loupe("Next image", "LoupeNextButton")
            ]),
            new("C", "Compare 2–4 selected photos",
            [
                Browse("Compare selected photos", "CompareViewButton"),
                Loupe("Compare selected photos", "CompareViewButton")
            ]),
        ...
        new("Organize",
        [
            new("P", "Set Picked on the Browse selection, else active photo; active-only in Develop, Loupe, or Compare",
            ...
            new("X", "Set Rejected on the Browse selection, else active photo; active-only in Develop, Loupe, or Compare",
                [Browse("Reject images", "RejectImageButton")]),
            new("`", "Toggle Picked on the assessment target",
                [Browse("Toggle Picked", "PickImageButton")]),
            new("1–5", "Set the Browse selection rating, or clear a uniform repeated rating; active-only in Develop, Loupe, or Compare",
            [
            ...
            new("0", "Clear ratings on the Browse selection, else active photo; active-only in Develop, Loupe, or Compare",
        ...
        [
            new("\\", "Toggle before/after in Develop or fullscreen",
            ...
            new("L", "Toggle color assessment mode in Develop or fullscreen",
                [Develop("Toggle color assessment", "ColorAssessmentButton")]),
            new("Space  /  Z", "Toggle fit and 1:1 in Develop or Browse Loupe",
            [
                Develop("Toggle fit and 1:1", "ActualSizeButton"),
                Loupe("Toggle fit and 1:1", "LoupeActualSizeButton")
            ]),
            new("W", "Toggle the white balance eyedropper",
                [Develop("Toggle the white balance eyedropper", "WhiteBalancePickerButton")]),
            new("Shift+W", "Toggle Locals in Develop", [Develop("Toggle Locals", "LocalsModeButton")]),
            new("O", "Toggle Show Mask while Locals is open", [Develop("Toggle Show Mask", "ShowLocalMaskButton")]),
            new("B", "Open Locals and arm Brush", [Develop("Arm Brush", "AddBrushButton")]),
            new("[  /  ]", "Scale brush radius by 0.8 / 1.25 while Brush is visible",
                [Develop("Change brush size", "BrushSizeSlider")]),
            new("Shift+[  /  Shift+]", "Change brush Feather by -10 / +10 points",
                [Develop("Change brush feather", "BrushFeatherSlider")]),
            new("Hold Alt", "Invert Paint/Erase for a stroke started while held",
                [Develop("Paint", "BrushPaintButton"), Develop("Erase", "BrushEraseButton")]),
            new("Hold M", "Temporarily show the mask while Locals is open", [Develop("Show Mask", "ShowLocalMaskButton")]),
        ...
        new("Export",
        [
            new("Ctrl+Shift+E", "Open the Export workspace (ignored in fullscreen)",
